 ...
 */
	...
	$.jstree.plugins.search = function (options, parent) {
		...
		this.search = function (str, skip_async, show_only_matches, inside, append, show_only_matches_children) {
			...
			str = self.removeDiacritics(str.toString());
			...
			$.each(m[inside ? inside : $.jstree.root].children_d, function (ii, i) {
				var v = m[i];
				if (v.text && ((s.search_callback && s.search_callback.call(this, str, v)) || (!s.search_callback && f.search(self.removeDiacritics(v.text)).isMatch)) && (!s.search_leaves_only || (v.state.loaded && v.children.length === 0))) {
					r.push(i);
